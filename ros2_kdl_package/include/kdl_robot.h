...
public:
    ...
    Eigen::VectorXd getFD(const KDL::JntArray &torques, const KDL::JntArray &q, const KDL::JntArray &qdot);
    ...
    KDL::Twist getEEJacDotqdot();

    // inverse kinematics
    void getInverseKinematics(KDL::Frame &f, KDL::JntArray &q); 
    void getForwardKinematics(KDL::Frame &f, KDL::JntArray &q, int segmentNr); 
    void getInverseKinematicsVel(KDL::JntArray &q, KDL::Twist &t, KDL::JntArray &qdot);  
    //void getInverseKinematicsAcc(KDL::JntArray &q, KDL::JntArray &qdot, KDL::Twist &acc, KDL::JntArray &q_ddot);
